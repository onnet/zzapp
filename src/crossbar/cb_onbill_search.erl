...
-spec init() -> 'ok'.
init() ->
    _ = crossbar_bindings:bind(<<"*.allowed_methods.onbill_search">>, ?MODULE, 'allowed_methods'),
    _ = crossbar_bindings:bind(<<"*.resource_exists.onbill_search">>, ?MODULE, 'resource_exists'),
    _ = crossbar_bindings:bind(<<"*.authorize.onbill_search">>, ?MODULE, 'authorize'),
    _ = crossbar_bindings:bind(<<"*.validate.onbill_search">>, ?MODULE, 'validate').
...
validate(Context) ->
    ...
    Ctx = cb_context:set_account_db(Context, search_db(Context)),
